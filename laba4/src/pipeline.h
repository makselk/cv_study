...
namespace PIPELINE {
    ...
    // Выполняет перевод двухканального комплексного изображения,
    // полученного обратным преобразованием фурье, в одноканальное черно-белое
    cv::Mat reverseComplexToReal(cv::Mat& complex_image);
